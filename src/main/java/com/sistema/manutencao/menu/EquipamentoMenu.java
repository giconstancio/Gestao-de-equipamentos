...
public class EquipamentoMenu {
    ...
    // fica em loop mostrando o menu até a pessoa escolher voltar (opção 0)
    ...
    // pede os dados pelo terminal, confere se preencheu tudo certo e manda pro DAO gravar
    private void cadastrarEquipamento() {
        ...
        try {
            ...
            // código, nome e localização não podem ficar em branco
            ...
            // não deixa cadastrar dois equipamentos com o mesmo patrimônio
    ...
    // mostra todos os equipamentos numa tabelinha formatada no terminal
    ...
    // pede o id pro usuário e mostra os detalhes completos daquele equipamento
